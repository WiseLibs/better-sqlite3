...
#line 10 "./src/util/constants.lzz"
                ...
                SetString(isolate, defaultTransactionBehavior, "defaultTransactionBehavior");
...
#line 149 "./src/objects/database.lzz"
                ...
                if ( info . Length ( ) <= ( 6 ) ) return ThrowTypeError ( "Expected a " "seventh" " argument" ) ; v8 :: Local < v8 :: Value > default_transaction_behavior = info [ 6 ] ;
                ...
                SetFrozen(isolate, ctx, info.This(), addon->cs.defaultTransactionBehavior, default_transaction_behavior);
...
#line 277 "./src/objects/database.lzz"
