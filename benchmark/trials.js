...
exports.default = [
	...
	{ type: 'select-array', table: 'small', columns: ['nul', 'integer', 'real', 'text'],
		description: 'reading rows individually into arrays' },
	{ type: 'select-all', table: 'small', columns: ['nul', 'integer', 'real', 'text'],
		description: 'reading 100 rows into an array' },
	{ type: 'select-all-array', table: 'small', columns: ['nul', 'integer', 'real', 'text'],
		description: 'reading 100 rows into an array with results as array' },
	{ type: 'select-iterate', table: 'small', columns: ['nul', 'integer', 'real', 'text'],
		description: 'iterating over 100 rows' },
	{ type: 'select-iterate-array', table: 'small', columns: ['nul', 'integer', 'real', 'text'],
		description: 'iterating over 100 rows with results as arrays' },
...
exports.searchable = [
	...
	{ type: 'select-array', table: 'small', columns: ['nul'] },
	{ type: 'select-array', table: 'small', columns: ['integer'] },
	{ type: 'select-array', table: 'small', columns: ['real'] },
	{ type: 'select-array', table: 'small', columns: ['text'] },
	{ type: 'select-array', table: 'small', columns: ['blob'] },
	{ type: 'select-array', table: 'large_text', columns: ['text'] },
	{ type: 'select-array', table: 'large_blob', columns: ['blob'] },
	...
	{ type: 'select-all-array', table: 'small', columns: ['nul'] },
	{ type: 'select-all-array', table: 'small', columns: ['integer'] },
	{ type: 'select-all-array', table: 'small', columns: ['real'] },
	{ type: 'select-all-array', table: 'small', columns: ['text'] },
	{ type: 'select-all-array', table: 'small', columns: ['blob'] },
	{ type: 'select-all-array', table: 'large_text', columns: ['text'] },
	{ type: 'select-all-array', table: 'large_blob', columns: ['blob'] },
	...
	{ type: 'select-iterate-array', table: 'small', columns: ['nul'] },
	{ type: 'select-iterate-array', table: 'small', columns: ['integer'] },
	{ type: 'select-iterate-array', table: 'small', columns: ['real'] },
	{ type: 'select-iterate-array', table: 'small', columns: ['text'] },
	{ type: 'select-iterate-array', table: 'small', columns: ['blob'] },
	{ type: 'select-iterate-array', table: 'large_text', columns: ['text'] },
	{ type: 'select-iterate-array', table: 'large_blob', columns: ['blob'] },
