...
exports.serialize = function serialize(sql) {
	return this[cppdb].serialize(sql, this, false);
};

exports.deserialize = function deserialize(sql) {
	return this[cppdb].deserialize(sql, this, false);
};
